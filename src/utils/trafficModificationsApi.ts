...
const mockTrafficModifications: TrafficModification[] = [
  {
    ...
    shortDescription: "Da lunedì 10 november, per lavori del comune di Torino, è prevista la chiusura dell'utimo tratto di corso Mortara in direzione piazza Baldissera con obbligo di svolta a destra su corso Principe Oddone.",
    fullDescription: "Da lunedì 10 november, per lavori del comune di Torino, è prevista la chiusura dell'utimo tratto di corso Mortara in direzione piazza Baldissera con obbligo di svolta a destra su corso Principe Oddone.",
    latitude: 45.0918,
    longitude: 7.66297,
    status: "red",
  },
  {
    ...
    shortDescription: "Giovedì 13 november dalle 9:30 alle 16:30, per lavori del Comune di Torino, è prevista la chiusura del sottopasso Mortara in direzione via Orvieto.",
    fullDescription: "Giovedì 13 november dalle 9:30 alle 16:30, per lavori del Comune di Torino, è prevista la chiusura del sottopasso Mortara in direzione via Orvieto.",
    latitude: 45.0918,
    longitude: 7.66297,
    status: "red",
  },
  {
    ...
    shortDescription: "Dalle 23:30 di giovedì 13 alle 1:30 di venerdì 14 november divieto di transito nel sottopasso Repubblica per pulizia meccanizzata.",
    fullDescription: "Dalle 23:30 di giovedì 13 alle 1:30 di venerdì 14 november divieto di transito nel sottopasso Repubblica per pulizia meccanizzata.",
    latitude: 45.0766,
    longitude: 7.68376,
    status: "red",
  },
  {
    ...
    shortDescription: "Venerdì 14 november dalle 2:30 alle 4:30 divieto di transito nel sottopasso Lanza per pulizia meccanizzata.",
    fullDescription: "Venerdì 14 november dalle 2:30 alle 4:30 divieto di transito nel sottopasso Lanza per pulizia meccanizzata.",
    latitude: 45.036,
    longitude: 7.67645,
    status: "red",
  },
...
export const useTrafficModifications = () => {
  return useQuery<TrafficModification[], Error>({
    queryKey: ["trafficModifications"],
    queryFn: fetchTrafficModifications,
